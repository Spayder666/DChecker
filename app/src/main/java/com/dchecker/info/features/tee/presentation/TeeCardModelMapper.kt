...
package com.dchecker.info.features.tee.presentation
...
import com.dchecker.info.features.tee.ui.model.TeeCertificateSummaryModel
import com.dchecker.info.features.tee.ui.model.TeeFactGroupModel
import com.dchecker.info.features.tee.ui.model.TeeFactIcon
import com.dchecker.info.features.tee.ui.model.TeeFactRowModel
import com.dchecker.info.features.tee.ui.model.TeeFooterActionId
import com.dchecker.info.features.tee.ui.model.TeeFooterActionModel
import com.dchecker.info.features.tee.ui.model.TeeHeaderFactModel
import com.dchecker.info.features.tee.ui.model.TeeHighlightSignalModel
import com.dchecker.info.features.tee.ui.model.TeeNetworkStateModel
...
class TeeCardModelMapper {
    ...
    private fun TeeReport.tierStatus(): DetectorStatus = when (tier) {
        com.dchecker.info.features.tee.domain.TeeTier.STRONGBOX,
        com.dchecker.info.features.tee.domain.TeeTier.TEE -> DetectorStatus.allClear()

        com.dchecker.info.features.tee.domain.TeeTier.SOFTWARE -> DetectorStatus.warning()
        com.dchecker.info.features.tee.domain.TeeTier.NONE -> DetectorStatus.danger()
        com.dchecker.info.features.tee.domain.TeeTier.UNKNOWN -> DetectorStatus.info(
            InfoKind.SUPPORT
        )
    }
    ...
    private fun com.dchecker.info.features.tee.domain.TeeTier.displayName(): String =
        when (this) {
            com.dchecker.info.features.tee.domain.TeeTier.UNKNOWN -> "Unknown"
            com.dchecker.info.features.tee.domain.TeeTier.NONE -> "None"
            com.dchecker.info.features.tee.domain.TeeTier.SOFTWARE -> "Software"
            com.dchecker.info.features.tee.domain.TeeTier.TEE -> "TEE"
            com.dchecker.info.features.tee.domain.TeeTier.STRONGBOX -> "StrongBox"
        }
}
