...
import com.dchecker.info.features.tee.domain.TeeEvidenceItem
import com.dchecker.info.features.tee.domain.TeeEvidenceSection
import com.dchecker.info.features.tee.domain.TeeNetworkMode
import com.dchecker.info.features.tee.domain.TeePatchGrade
import com.dchecker.info.features.tee.domain.TeePatchState
import com.dchecker.info.features.tee.domain.TeeReport
import com.dchecker.info.features.tee.domain.TeeScanStage
import com.dchecker.info.features.tee.domain.TeeSignal
...
import com.dchecker.info.features.tee.data.verification.keystore.MIN_RATIO_SAMPLE_COUNT
import com.dchecker.info.features.tee.data.verification.keystore.SupplementaryAttestationInfoAnomalyKind
import com.dchecker.info.features.tee.data.verification.keystore.TIMING_SIDE_CHANNEL_THRESHOLD_RATIO
...
import com.dchecker.info.features.tee.data.verification.keystore.Keystore2PostProcessingAnomalyKind
import com.dchecker.info.features.tee.data.verification.keystore.VintfKeyMintVersionAnomalyKind
import com.dchecker.info.features.tee.data.verification.rkp.RkpProvisionedManufacturerAnomalyKind
import com.dchecker.info.features.tee.data.verification.keystore.timingSideChannelRatio
...
class TeeReportReducer(
    ...
    private fun importKeyRetainedAttestationNarrativeValue(artifacts: TeeScanArtifacts): String {
        ...
        val status = when {
            result.anomalyKind == com.dchecker.info.features.tee.data.verification.keystore.ImportKeyRetainedAttestationAnomalyKind.IMPORT_UNSUPPORTED -> "Unavailable"
