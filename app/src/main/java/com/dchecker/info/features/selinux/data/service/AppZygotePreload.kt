...
package com.dchecker.info.features.selinux.data.service

import android.app.ZygotePreload
import android.content.pm.ApplicationInfo
import android.os.Build
import android.system.Os
import com.dchecker.info.features.selinux.data.native.SelinuxContextValidityBridge
import com.dchecker.info.features.selinux.data.native.SelinuxContextValidityPayloadCodec
...
import com.dchecker.info.features.selinux.data.probes.SelinuxPolicyloadSeqnoResult
...
class AppZygotePreload : ZygotePreload {
    ...
    companion object {
        ...
        internal fun augmentPreloadSnapshot(
            ...
            appUid: Int,
            isUserBuild: Boolean,
            inspectProcAttrCurrent: () -> List<com.dchecker.info.features.selinux.data.probes.SelinuxProcAttrCurrentResult>,
