...
package com.dchecker.info.features.tee.data.repository

import android.content.Context
import android.os.Build
import com.dchecker.info.features.tee.data.attestation.AndroidAttestationCollector
import com.dchecker.info.features.tee.data.native.TeeNativeBridge
import com.dchecker.info.features.tee.data.preferences.TeeNetworkConsentStore
import com.dchecker.info.features.tee.data.preferences.TeeNetworkPrefsStore
import com.dchecker.info.features.tee.data.report.TeeReportReducer
import com.dchecker.info.features.tee.data.report.TeeScanArtifacts
import com.dchecker.info.features.tee.data.soter.SoterCapabilityProbe
import com.dchecker.info.features.tee.data.verification.boot.BootConsistencyProbe
import com.dchecker.info.features.tee.data.verification.certificate.CertificateTrustAnalyzer
import com.dchecker.info.features.tee.data.verification.certificate.ChainStructureAnalyzer
import com.dchecker.info.features.tee.data.verification.certificate.DualAlgorithmChainProbe
import com.dchecker.info.features.tee.data.verification.certificate.GoogleAttestationRootStore
import com.dchecker.info.features.tee.data.verification.crl.CrlStatusService
import com.dchecker.info.features.tee.data.verification.keystore.IdAttestationProbe
import com.dchecker.info.features.tee.data.verification.keystore.AesGcmRoundTripProbe
import com.dchecker.info.features.tee.data.verification.keystore.BinderChainConsistencyProbe
import com.dchecker.info.features.tee.data.verification.keystore.BinderHookBootstrapProbe
import com.dchecker.info.features.tee.data.verification.keystore.BinderPatchModeProbe
import com.dchecker.info.features.tee.data.verification.keystore.BiometricTeeIntegrationProbe
import com.dchecker.info.features.tee.data.verification.keystore.ImportKeyRetainedAttestationNarrativeProbe
import com.dchecker.info.features.tee.data.verification.keystore.KeyLifecycleProbe
import com.dchecker.info.features.tee.data.verification.keystore.KeyMintCapabilityProbe
import com.dchecker.info.features.tee.data.verification.keystore.KeyMetadataSemanticsProbe
import com.dchecker.info.features.tee.data.verification.keystore.KeyMetadataShapeProbe
import com.dchecker.info.features.tee.data.verification.keystore.KeyPairConsistencyProbe
import com.dchecker.info.features.tee.data.verification.keystore.KeyboxImportProbe
import com.dchecker.info.features.tee.data.verification.keystore.Keystore2GenerateModeParcelFingerprintProbe
import com.dchecker.info.features.tee.data.verification.keystore.Keystore2HookProbe
import com.dchecker.info.features.tee.data.verification.keystore.GrantDomainFullChainSplitProbe
import com.dchecker.info.features.tee.data.verification.keystore.GrantDomainAnomalyKind
import com.dchecker.info.features.tee.data.verification.keystore.GrantDomainFullChainSplitResult
import com.dchecker.info.features.tee.data.verification.keystore.GrantSelfDomainFullChainSplitProbe
import com.dchecker.info.features.tee.data.verification.keystore.GrantSelfDomainAnomalyKind
import com.dchecker.info.features.tee.data.verification.keystore.GrantSelfDomainFullChainSplitResult
import com.dchecker.info.features.tee.data.verification.keystore.SyntheticGrantGetKeyEntryAccessVectorBlindnessProbe
import com.dchecker.info.features.tee.data.verification.keystore.SyntheticGrantGranteeBlindReadbackAnomalyKind
import com.dchecker.info.features.tee.data.verification.keystore.SyntheticGrantGranteeBlindReadbackProbe
import com.dchecker.info.features.tee.data.verification.keystore.SyntheticGrantGranteeBlindReadbackResult
import com.dchecker.info.features.tee.data.verification.keystore.LegacyKeystorePathProbe
import com.dchecker.info.features.tee.data.verification.keystore.ListEntriesBatchedProbe
import com.dchecker.info.features.tee.data.verification.keystore.ListEntriesConsistencyProbe
import com.dchecker.info.features.tee.data.verification.keystore.OperationErrorPathProbe
import com.dchecker.info.features.tee.data.verification.keystore.OperationPruningProbe
import com.dchecker.info.features.tee.data.verification.keystore.OversizedChallengeProbe
import com.dchecker.info.features.tee.data.verification.keystore.PureCertificateProbe
import com.dchecker.info.features.tee.data.verification.keystore.PureCertificateSecurityLevelProbe
import com.dchecker.info.features.tee.data.verification.keystore.SupplementaryAttestationInfoProbe
import com.dchecker.info.features.tee.data.verification.keystore.TimingAnomalyProbe
import com.dchecker.info.features.tee.data.verification.keystore.TimingSideChannelProbe
import com.dchecker.info.features.tee.data.verification.keystore.UpdateSubcomponentProbe
import com.dchecker.info.features.tee.data.verification.keystore.UpdateSubcomponentStaleResponsePersistenceProbe
import com.dchecker.info.features.tee.data.verification.keystore.Keystore2PostProcessingProbe
import com.dchecker.info.features.tee.data.verification.keystore.Keystore2PostProcessingResult
import com.dchecker.info.features.tee.data.verification.rkp.RkpProvisionedManufacturerProbe
import com.dchecker.info.features.tee.data.verification.keystore.VintfKeyMintVersionProbe
import com.dchecker.info.features.tee.data.verification.keystore.VintfKeyMintVersionFamily
import com.dchecker.info.features.tee.data.verification.keystore.VintfKeyMintVersionResult
import com.dchecker.info.features.tee.data.verification.rkp.RkpExtensionAnalyzer
import com.dchecker.info.features.tee.data.verification.strongbox.StrongBoxBehaviorProbeSuite
import com.dchecker.info.features.tee.domain.TeeReport
import com.dchecker.info.features.tee.domain.TeeSoterState
import com.dchecker.info.features.tee.domain.TeeTier
...
class TeeRepository(
    ...
    private suspend fun collectDeepChecks(
        ...
        snapshot: com.dchecker.info.features.tee.data.attestation.AttestationSnapshot,
        vintfKeyMintVersion: VintfKeyMintVersionResult,
        timingSideChannel: com.dchecker.info.features.tee.data.verification.keystore.TimingSideChannelResult,
...
private data class DeferredChecks(
    val pairConsistency: com.dchecker.info.features.tee.data.verification.keystore.KeyPairConsistencyResult,
    val aesGcm: com.dchecker.info.features.tee.data.verification.keystore.AesGcmRoundTripResult,
    val lifecycle: com.dchecker.info.features.tee.data.verification.keystore.KeyLifecycleResult,
    val keyMintCapability: com.dchecker.info.features.tee.data.verification.keystore.KeyMintCapabilityResult,
    val timing: com.dchecker.info.features.tee.data.verification.keystore.TimingAnomalyResult,
    val timingSideChannel: com.dchecker.info.features.tee.data.verification.keystore.TimingSideChannelResult,
    val oversizedChallenge: com.dchecker.info.features.tee.data.verification.keystore.OversizedChallengeResult,
    val keyboxImport: com.dchecker.info.features.tee.data.verification.keystore.KeyboxImportResult,
    val importKeyRetainedAttestationNarrative: com.dchecker.info.features.tee.data.verification.keystore.ImportKeyRetainedAttestationNarrativeResult,
    val keystore2Hook: com.dchecker.info.features.tee.data.verification.keystore.Keystore2HookResult,
    val generateModeParcelFingerprint: com.dchecker.info.features.tee.data.verification.keystore.Keystore2GenerateModeParcelFingerprintResult,
    val grantDomainFullChainSplit: com.dchecker.info.features.tee.data.verification.keystore.GrantDomainFullChainSplitResult,
    val syntheticGrantGranteeBlindReadback: com.dchecker.info.features.tee.data.verification.keystore.SyntheticGrantGranteeBlindReadbackResult,
    val syntheticGrantGetKeyEntryAccessVectorBlindness: com.dchecker.info.features.tee.data.verification.keystore.SyntheticGrantGetKeyEntryAccessVectorBlindnessResult,
    val grantSelfDomainFullChainSplit: com.dchecker.info.features.tee.data.verification.keystore.GrantSelfDomainFullChainSplitResult,
    val legacyKeystorePath: com.dchecker.info.features.tee.data.verification.keystore.LegacyKeystorePathResult,
    val listEntriesConsistency: com.dchecker.info.features.tee.data.verification.keystore.ListEntriesConsistencyResult,
    val listEntriesBatched: com.dchecker.info.features.tee.data.verification.keystore.ListEntriesBatchedResult,
    val keyMetadataSemantics: com.dchecker.info.features.tee.data.verification.keystore.KeyMetadataSemanticsResult,
    val keyMetadataShape: com.dchecker.info.features.tee.data.verification.keystore.KeyMetadataShapeResult,
    val pureCertificate: com.dchecker.info.features.tee.data.verification.keystore.PureCertificateResult,
    val pureCertificateSecurityLevel: com.dchecker.info.features.tee.data.verification.keystore.PureCertificateSecurityLevelResult,
    val operationErrorPath: com.dchecker.info.features.tee.data.verification.keystore.OperationErrorPathResult,
    val biometricIntegration: com.dchecker.info.features.tee.data.verification.keystore.BiometricTeeIntegrationResult,
    val binderHookBootstrap: com.dchecker.info.features.tee.data.verification.keystore.BinderHookBootstrapResult,
    val binderPatchMode: com.dchecker.info.features.tee.data.verification.keystore.BinderPatchModeResult,
    val binderChainConsistency: com.dchecker.info.features.tee.data.verification.keystore.BinderChainConsistencyResult,
    val updateSubcomponent: com.dchecker.info.features.tee.data.verification.keystore.UpdateSubcomponentResult,
    val updateSubcomponentStaleResponsePersistence: com.dchecker.info.features.tee.data.verification.keystore.UpdateSubcomponentStaleResponsePersistenceResult,
    val pruning: com.dchecker.info.features.tee.data.verification.keystore.OperationPruningResult,
    val dualAlgorithm: com.dchecker.info.features.tee.data.verification.certificate.DualAlgorithmChainResult,
    val idAttestation: com.dchecker.info.features.tee.data.verification.keystore.IdAttestationResult,
    val strongBox: com.dchecker.info.features.tee.data.verification.strongbox.StrongBoxBehaviorResult,
) {
    companion object {
        fun skipped(
            snapshot: com.dchecker.info.features.tee.data.attestation.AttestationSnapshot,
            ...
            pairConsistency = com.dchecker.info.features.tee.data.verification.keystore.KeyPairConsistencyResult(
                keyMatchesCertificate = true,
                detail = "Deep checks were skipped because hardware-backed attestation was not established.",
            ),
            aesGcm = com.dchecker.info.features.tee.data.verification.keystore.AesGcmRoundTripResult(
                executed = false,
                detail = "AES-GCM round-trip probe skipped.",
            ),
            lifecycle = com.dchecker.info.features.tee.data.verification.keystore.KeyLifecycleResult(
                created = false,
                deleteRemovedAlias = true,
                regeneratedFreshMaterial = true,
                detail = "Lifecycle probe skipped.",
            ),
            keyMintCapability = com.dchecker.info.features.tee.data.verification.keystore.KeyMintCapabilityResult(
                executed = false,
            ),
            timing = com.dchecker.info.features.tee.data.verification.keystore.TimingAnomalyResult(
                suspicious = false,
                detail = "Timing probe skipped.",
            ),
            timingSideChannel = timingSideChannel,

            oversizedChallenge = com.dchecker.info.features.tee.data.verification.keystore.OversizedChallengeResult(
                acceptedOversizedChallenge = false,
                acceptedSizes = emptyList(),
                attemptedSizes = com.dchecker.info.features.tee.data.verification.keystore.OversizedChallengeProbe.CHALLENGE_SIZES,
                detail = "Oversized challenge probe skipped.",
            ),
            keyboxImport = com.dchecker.info.features.tee.data.verification.keystore.KeyboxImportResult(
                executed = false,
                markerPreserved = true,
                marker = com.dchecker.info.features.tee.data.verification.keystore.KeyboxImportProbe.FIXTURE_MARKER,
                detail = "Keybox import probe skipped.",
            ),
            importKeyRetainedAttestationNarrative = com.dchecker.info.features.tee.data.verification.keystore.ImportKeyRetainedAttestationNarrativeResult(
                executed = false,
                detail = "ImportKey retained attestation narrative probe skipped.",
            ),
            keystore2Hook = com.dchecker.info.features.tee.data.verification.keystore.Keystore2HookResult(
                available = false,
                detail = "Keystore2 hook probe skipped.",
            ),
            generateModeParcelFingerprint = com.dchecker.info.features.tee.data.verification.keystore.Keystore2GenerateModeParcelFingerprintResult(
                executed = false,
                detail = "Keystore2 generate-mode parcel fingerprint probe skipped.",
            ),
            grantDomainFullChainSplit = com.dchecker.info.features.tee.data.verification.keystore.GrantDomainFullChainSplitResult(
                detail = "Grant-domain full-chain split probe skipped.",
            ),
            syntheticGrantGranteeBlindReadback = com.dchecker.info.features.tee.data.verification.keystore.SyntheticGrantGranteeBlindReadbackResult(
                detail = "Grant caller-binding private binder probe skipped.",
            ),
            syntheticGrantGetKeyEntryAccessVectorBlindness =
                com.dchecker.info.features.tee.data.verification.keystore.SyntheticGrantGetKeyEntryAccessVectorBlindnessResult(
                    detail = "Grant access-vector private binder probe skipped.",
                ),
            grantSelfDomainFullChainSplit = com.dchecker.info.features.tee.data.verification.keystore.GrantSelfDomainFullChainSplitResult(
                detail = "Grant self-domain full-chain split probe skipped.",
            ),
            legacyKeystorePath = com.dchecker.info.features.tee.data.verification.keystore.LegacyKeystorePathResult(
                executed = false,
                detail = "Legacy keystore path probe skipped.",
            ),
            listEntriesConsistency = com.dchecker.info.features.tee.data.verification.keystore.ListEntriesConsistencyResult(
                executed = false,
                detail = "listEntries consistency probe skipped.",
            ),
            listEntriesBatched = com.dchecker.info.features.tee.data.verification.keystore.ListEntriesBatchedResult(
                executed = false,
                detail = "listEntriesBatched probe skipped.",
            ),
            keyMetadataSemantics = com.dchecker.info.features.tee.data.verification.keystore.KeyMetadataSemanticsResult(
                executed = false,
                detail = "KeyMetadata semantics probe skipped.",
            ),
            keyMetadataShape = com.dchecker.info.features.tee.data.verification.keystore.KeyMetadataShapeResult(
                executed = false,
                detail = "KeyMetadata shape probe skipped.",
            ),
            pureCertificate = com.dchecker.info.features.tee.data.verification.keystore.PureCertificateResult(
                pureCertificateReturnsNullKey = true,
                detail = "Pure certificate probe skipped.",
            ),
            pureCertificateSecurityLevel = com.dchecker.info.features.tee.data.verification.keystore.PureCertificateSecurityLevelResult(
                executed = false,
                detail = "Pure certificate security-level probe skipped.",
            ),
            operationErrorPath = com.dchecker.info.features.tee.data.verification.keystore.OperationErrorPathResult(
                executed = false,
                detail = "Operation error-path probe skipped.",
            ),
            biometricIntegration = com.dchecker.info.features.tee.data.verification.keystore.BiometricTeeIntegrationResult(
                executed = false,
                detail = "Biometric TEE integration probe skipped.",
            ),
            binderHookBootstrap = com.dchecker.info.features.tee.data.verification.keystore.BinderHookBootstrapResult(
                executed = false,
                detail = "Binder hook bootstrap probe skipped.",
            ),
            binderPatchMode = com.dchecker.info.features.tee.data.verification.keystore.BinderPatchModeResult(
                executed = false,
                detail = "Binder patch-mode probe skipped.",
            ),
            binderChainConsistency = com.dchecker.info.features.tee.data.verification.keystore.BinderChainConsistencyResult(
                executed = false,
                detail = "Binder chain consistency probe skipped.",
            ),
            updateSubcomponent = com.dchecker.info.features.tee.data.verification.keystore.UpdateSubcomponentResult(
                updateSucceeded = true,
                keyNotFoundStyleFailure = false,
                detail = "Update subcomponent probe skipped.",
            ),
            updateSubcomponentStaleResponsePersistence =
                com.dchecker.info.features.tee.data.verification.keystore.UpdateSubcomponentStaleResponsePersistenceResult(
                    detail = "UpdateSubcomponent stale response persistence probe skipped.",
                ),
            pruning = com.dchecker.info.features.tee.data.verification.keystore.OperationPruningResult(
                suspicious = false,
                operationsCreated = 0,
                invalidatedOperations = 0,
                detail = "Pruning probe skipped.",
            ),
            dualAlgorithm = com.dchecker.info.features.tee.data.verification.certificate.DualAlgorithmChainResult(
                mismatchDetected = false,
                detail = "Dual algorithm comparison skipped.",
            ),
            idAttestation = com.dchecker.info.features.tee.data.verification.keystore.IdAttestationResult(
                mismatches = emptyList(),
                unavailableFields = emptyList(),
                detail = "ID attestation probe skipped.",
                probeRan = false,
            ),
            strongBox = com.dchecker.info.features.tee.data.verification.strongbox.StrongBoxBehaviorResult(
                requested = false,
                advertised = false,
                available = false,
