...
package com.dchecker.info.features.virtualization.data.probes
...
class DexPathProbeTest {
    ...
    fun `host apk path hit maps to danger`() {
        val result = probe.evaluate(
            ...
            sourceDir = "/data/app/com.dchecker.info/base.apk",
            splitSourceDirs = emptyList(),
            packageName = "com.dchecker.info",
        )
    ...
    fun `split source mismatch only maps to warning`() {
        val result = probe.evaluate(
            entries = listOf("/data/app/com.dchecker.info/base.apk"),
            sourceDir = "/data/app/com.dchecker.info/base.apk",
            splitSourceDirs = listOf("/data/app/com.dchecker.info/split_config.arm64_v8a.apk"),
            packageName = "com.dchecker.info",
        )
    ...
    fun `own overlay dex path is ignored`() {
        val result = probe.evaluate(
            entries = listOf(
                "/data/data/com.dchecker.info/code_cache/.overlay/base.apk/classes10.dex",
                "/data/app/com.dchecker.info/base.apk",
            ),
            sourceDir = "/data/app/com.dchecker.info/base.apk",
            splitSourceDirs = emptyList(),
