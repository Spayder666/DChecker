...
import com.dchecker.info.features.tee.data.attestation.AttestedApplicationInfo
import com.dchecker.info.features.tee.data.attestation.AttestedAuthState
import com.dchecker.info.features.tee.data.attestation.AttestedDeviceInfo
import com.dchecker.info.features.tee.data.attestation.AttestedKeyProperties
import com.dchecker.info.features.tee.data.attestation.RootOfTrustSnapshot
...
import com.dchecker.info.features.tee.data.verification.crl.RevokedCertificate
import com.dchecker.info.features.tee.data.verification.crl.RevokedCertificateEvidenceKind
...
import com.dchecker.info.features.tee.data.verification.keystore.SyntheticGrantGetKeyEntryAccessVectorBlindnessAnomalyKind
...
import com.dchecker.info.features.tee.data.verification.keystore.ImportKeyRetainedAttestationAnomalyKind
...
import com.dchecker.info.features.tee.data.verification.keystore.KeyMintCryptoCapabilityResult
...
import com.dchecker.info.features.tee.data.verification.keystore.SupplementaryAttestationInfoAnomalyKind
...
import com.dchecker.info.features.tee.data.verification.keystore.UpdateSubcomponentStaleResponseAnomalyKind
import com.dchecker.info.features.tee.data.verification.keystore.UpdateSubcomponentStaleResponsePersistenceResult
import com.dchecker.info.features.tee.data.verification.keystore.VintfKeyMintVersionAnomalyKind
import com.dchecker.info.features.tee.data.verification.keystore.VintfKeyMintVersionDeclaration
...
import com.dchecker.info.features.tee.domain.TeeNetworkMode
import com.dchecker.info.features.tee.domain.TeeNetworkState
import com.dchecker.info.features.tee.domain.TeeRkpState
import com.dchecker.info.features.tee.domain.TeeSignalLevel
...
import com.dchecker.info.features.tee.domain.TeeVerdict
    ...
    private fun baseArtifacts(
        ...
        return TeeScanArtifacts(
            snapshot = AttestationSnapshot(
                ...
                applicationInfo = AttestedApplicationInfo(packageNames = listOf("com.dchecker.info")),
